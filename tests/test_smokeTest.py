...
class TestSmokeTest():
  ...
  def test_homePageSpotlights(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1520, 680)
    ...
    assert len(elements) > 0
    self.vars["URL"] = self.driver.execute_script("return document.querySelector(\'a.a-button\').href")
    self.driver.find_element(By.LINK_TEXT, "Join Us").click()
    self.vars["newURL"] = self.driver.execute_script("return document.URL")
    assert (self.vars["URL"] == self.vars["newURL"])
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Doe Inc")
